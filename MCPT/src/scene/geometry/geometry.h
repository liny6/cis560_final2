...
//Functions
    ...
    //shoots a random ray from a hemisphere given an intersection
    virtual Ray GetRandRay(float rand1, float rand2, const Intersection &isx);


//Member variables, const glm::vec3 &isx_normal
